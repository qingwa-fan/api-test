...
TEST_DATA_PLAN = os.path.join(DATA_DIR, "test_fdp_payment_fns105.json")

logging = Logger(__name__).get_logger()
@allure.feature('应付付款接口_FNS105')
            ...
            try:
                ...
                if case_data["check_sql_01"]:
                    if case_data["case_id"] == 'case_0':
                        ...
                        try:
                            assert db_actual_results_01[0][0] == case_data["json"]["apPaymentHeaderReqs"][0]["sourceTrxId"]
                ...
                if case_data["check_sql_02"]:
                    if case_data["case_id"] == 'case_0':
                        ...
                        try:
                            assert db_actual_results_02[0][0] == case_data["json"]["apPaymentHeaderReqs"][0]["sourceTrxId"]
...
if __name__ == '__main__':
    self_payment_FNS105 = TestPaymentFNS105()
    self_payment_FNS105.test_payment_FNS105()